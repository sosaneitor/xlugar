...
Every list on xLugar — the [home grid](/), the [full catalog](/models), and each [category page](/models/colombian) — is sorted by how many people are watching each room **right now**. The busiest rooms float to the top. There's no editorial thumb on the scale: ordering is driven purely by live viewer counts.
...
The thumbnails refresh roughly every minute. They're previews to help you scan — the real action is inside the room. When something catches your eye, click through to the [live stream](/models) and see it for yourself.
